...
g= datetime.datetime(2023, 8, 2, 1, 00 ,0)

if (x.strftime("%x"))>(g.strftime("%x")):
 print('\n\n')
 print("     "+' تم ايقاف الاده راسل هيروكو لتفعيل @FG_on')
 print('\n\n')
 print(x)
...
#		method.append('touch')
		...
		method.append('mobile')
	print('')
	_jembot_ = input('>> SHOW COOKIE (1/2)')
	if _jembot_ in ['']:
